...
public class CassieEntity extends PathfinderMob implements GeoEntity {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createLivingAttributes()
                ...
                .add(Attributes.STEP_HEIGHT, 12f);
    }
    ...
    public void checkGoal (CassieEntity entity) {
        ...
        if (tickCountGoalStateCheck == 80) {
            if (this.goalSelector.getAvailableGoals().stream().noneMatch
    ...
    public void playerGetRandomEffect (Player player, Holder<MobEffect> effect) {
